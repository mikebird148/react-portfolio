...
// TODO 
// set form to be fixed when scrolling
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            logo: "",
            editMode: false,
            apiUrl: "https://mikebird148.devcamp.space/portfolio/portfolio_items",
            apiAction: "post"
        };
    ...
    // TODO
    // create component for this and deleteImage in blog-form.js
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                url: url || "",
                editMode: true,
                apiUrl: `https://mikebird148.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: "patch",
