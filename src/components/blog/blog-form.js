...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            content: "",
            featured_image: "",
            apiUrl: "https://mikebird148.devcamp.space/portfolio/portfolio_blogs",
            apiAction: "post"
        };
    ...
    componentWillMount() {
        if (this.props.editMode) {
            this.setState({
                // TODO 
                // destructure each key and value to say id: id, etc.
                id: this.props.blog.id,
                title: this.props.blog.title,
                blog_status: this.props.blog.blog_status,
                content: this.props.blog.content,
                apiUrl: `https://mikebird148.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
                apiAction: "patch"
            });
        }
    }
    ...
    // TODO
    // create component for this and deleteImage in portfolio-form.js
